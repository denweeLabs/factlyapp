...
/// 📘 Animate Do
///
/// The code in the "animate_do" folder 99% took from "animate_do" package
/// and slightly adjusted to personal needs
///
/// Check official library at [https://pub.dev/packages/animate_do]
/// =====================================================
library;
...
mixin AnimateDoState {
  ...
  void buildAnimation({
    ...
    if (!animate) {
      ...
      // if flag has changed to false, finish animation instantly and animate back to 0
      if (!isFirstTime && forceComplete) {
